...
async function getData() {
    const res = await fetch(`https://${process.env.NEXT_PUBLIC_VERCEL_URL}/api/public-transports/realtime/mybas-johor`, { next: { revalidate: 3 } })
...
export default async function MyBasJohor() {
