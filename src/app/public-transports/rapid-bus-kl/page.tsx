...
async function getData() {
    const res = await fetch(`https://${process.env.NEXT_PUBLIC_VERCEL_URL}/api/public-transports/realtime/rapid-bus-kl`, { next: { revalidate: 3 } })
                    ...
                    <div key={index} className="rounded-lg bg-white/5 py-4 m-1 p-4">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute top-1 right-1 inline-flex items-center rounded-full bg-purple-700 px-3 py-1">
                                ...
                                <p>{item.vehicle.trip.routeId.slice(0, -1)}</p>
                            </div>
