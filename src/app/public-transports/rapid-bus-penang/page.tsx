...
async function getData() {
    const res = await fetch(`https://${process.env.NEXT_PUBLIC_VERCEL_URL}/api/public-transports/realtime/rapid-bus-penang`, { next: { revalidate: 3 } })
